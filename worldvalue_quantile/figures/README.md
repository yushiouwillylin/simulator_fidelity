...
- `worldvalue_benchmark_calibrated_vs_simulator_assisted_plugin.png`: calibrated curves overlaid with the full-data simulator-assisted predictive benchmark `plugin_XQ`
- `worldvalue_benchmark_calibrated_vs_question_only_plugin.png`: calibrated curves overlaid with the full-data question-only predictive benchmark `plugin_X`
- `worldvalue_benchmark_question_only_vs_simulator_assisted_plugin.png`: direct comparison of the two predictive benchmark families without the calibrated curves
